package com.xmm.cactus.ui.pullableview;
...
import com.xmm.cactus.ui.pullableview.Pullable;
...
public class PullToRefreshLayout extends RelativeLayout
{
	...
	// 加载完毕
	public static final int RESULT_LOADEND = 3;
	// 按下Y坐标，上一个事件点Y坐标
	...
	public void refreshFinish(int refreshResult)
	{
		...
		case RESULT_NODATA:
			// 刷新失败
			refreshStateImageView.setVisibility(View.VISIBLE);
			refreshStateTextView.setText(R.string.refresh_no_data);
			refreshStateImageView.setBackgroundResource(R.drawable.refresh_failed);
			break;
		default:
			break;
	...
	public void loadmoreFinish(int refreshResult)
	{
		...
		case RESULT_LOADEND:
			// 加载失败
			loadStateImageView.setVisibility(View.INVISIBLE);
			loadStateTextView.setText(R.string.load_data_end);
			break;
		default:
			break;
		}
