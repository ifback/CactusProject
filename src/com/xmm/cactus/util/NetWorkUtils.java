...
public class NetWorkUtils {
    ...
    public static boolean getOnlyWifiLoadImg(Context ctx) {
        return SharedPreferencesUtils.getInstance().getBoolean(ONLY_WIFI_LOAD_IMG,true);
    }

    public static void setOnlyWifiLoadImg(Context ctx, boolean isOn) {
    	SharedPreferencesUtils.getInstance().putBoolean(ONLY_WIFI_LOAD_IMG, isOn);
    }
